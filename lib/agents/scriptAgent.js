...
export async function generateScript(researchBrief, options = {}) {
  ...
  // 3. Construct System Instruction for Gemini
  const systemInstruction = `You are a professional video scriptwriter. Your job is to transform the provided Research Brief into a compelling, creator-ready video script.
